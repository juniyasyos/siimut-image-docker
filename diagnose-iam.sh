...
echo "Testing: GET http://192.168.1.9:8010/api/sso/verify"
docker compose -f docker-compose-multi-apps.yml exec -T app-iam curl -s http://192.168.1.9:8010/api/sso/verify -H "Authorization: Bearer invalid" 2>&1 | head -20
echo ""
