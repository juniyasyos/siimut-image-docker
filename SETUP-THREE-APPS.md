...
- Memory: 1.5GB limit, 768MB reservation
- CPU: 1.5 limit, 0.75 reservation
- Public URL: `http://192.168.1.4:8001`
...
- **SIIMUT**: http://192.168.1.4:8000
- **IKP**: http://192.168.1.4:8001
- **IAM**: http://192.168.1.4:8100 (if enabled)
...
7. Access via `http://192.168.1.4:8001`
